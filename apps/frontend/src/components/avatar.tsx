...
Command: npx gltfjsx@6.5.3 apps/frontend/public/models/6765b17acceb762d9021d41d.glb -o apps/frontend/src/components/avatar.tsx -r public -t
*/
...
export function Avatar(props: JSX.IntrinsicElements['group']) {
  ...
  const [animation] = useState<string>('Talking_0');
